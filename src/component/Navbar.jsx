...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="flex flex-col md:flex-row top-0 left-0 right-0 bg-white/90 backdrop-blur-sm z-50 border-b border-gray-100 shadow-md fixed">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white shadow-md w-full px-6 py-4 flex flex-col gap-4">
            ...
            <a
              href="#newsLetter"
              className="bg-blue-600 text-white text-center px-6 py-2 rounded-lg hover:bg-blue-900 text-sm transition-all"
